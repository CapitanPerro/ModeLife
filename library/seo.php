...
function theme_ld_meta_tags() {
    ...
    $logo = theme_get_logo(array('default_src' => "/images/7f83d16629da851aff1c616149f6d0f601439c2b16bf553121a2f62d800b25af3b38b1f8095bea7db5512b1475739eb520ad85384bc56dbf401c90_1280.png", 'default_url' => ''));
    if (!empty($logo['src'])) {
...
function theme_color_meta_tags() {
    $theme_color = apply_filters('theme_color', '#0063b1');
